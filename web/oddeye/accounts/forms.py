...
class RegisterForm(forms.Form):
    username = forms.CharField(error_messages={'required': '아이디를 입력해주세요.'}, max_length=15, label="아이디")
...
class LoginForm(forms.Form):
    ...
    def clean(self):
        ...
        if username and password:
            try:
                oddeye_user = OddeyeUsers.objects.get(username=username)
